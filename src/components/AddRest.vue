...
import FooterMain from "./layouts/footer-main.vue";
...
const handleSubmit = async () => {
  ...
  try {
    const res = await axios.post(`http://localhost:3000/resaurant`, submitInfo.value);
    ...
    showNotification("error", "Failed to add restaurant. Please try again.");
